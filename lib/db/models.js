...
external.Story = vogels.define('Story', {
  tableName: 'Stories',
  hashKey: 'id',
  // createdAt, updatedAt
  timestamps: true,
...
external.TopicStory = vogels.define('TopicStory', {
...
Promise.promisifyAll(external.Story);
Promise.promisifyAll(external.TopicStory);
